...
Plans:
- [ ] 10-01-PLAN.md — Design system: apply design-system2.html patterns to alias routes + AboutSection
- [ ] 10-02-PLAN.md — Home scroll fix: release snap-scroll past last section + "about" pen pose/animation
